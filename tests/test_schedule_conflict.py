...
class ScheduleConflictTest(unittest.TestCase):
    def test_conflict_detection(self):
        ...
        self.assertEqual(result["decision"], "conflict_detected")
        self.assertEqual(len(result.get("details", {}).get("conflicts", [])), 1)
        conflict = result.get("details", {}).get("conflicts", [])[0]
    ...
    def test_no_conflict(self):
        ...
        self.assertEqual(result["decision"], "no_conflict")
